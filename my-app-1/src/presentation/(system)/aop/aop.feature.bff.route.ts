...
import { withErrorHandlingAsync } from '@/presentation/(system)/aop/aop.core.exception.bff';
import { Ctx, withLoggingAsync } from '@/presentation/(system)/aop/aop.core.logging';
import { withResultParsingAsync } from '@/presentation/(system)/aop/aop.core.result.bff.route';
